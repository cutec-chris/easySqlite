...
(* Contains classes for connecting to SQLite databases. *)
unit EasySqlite;
{$MODE ObjFpc}
{$H+}
...
type
  ...
  TSqliteStatement = class(TObject)
    ...
    public
      ...
      (* Binds a Float to all params with name
         @param(ParamName the full identifier of the parameter with param prefix included) *)
      ...
      function ResetStatement: TSqliteStatement;
...
function TSqliteStatement.LastInsertRow: Int64;
begin
...
function TSqliteStatement.ResetStatement: TSqliteStatement;
begin
